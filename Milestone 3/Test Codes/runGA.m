...
GA.Survivor = 0; % if 1 do fitness based selection, if 0 do Age based selection
...
Best_Fitness = zeros(GA.Num_Generations,1); %initialize an empty array to store the fitnesses
%% Initial step:

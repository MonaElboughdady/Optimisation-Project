...
% Controller.controller = controllerPurePursuit("DesiredLinearVelocity",Controller.desiredLinearVelocity,"MaxAngularVelocity",Controller.maxAngularVelocity,"LookaheadDistance",Controller.lookaheadDistance);
...
% Controller.controllers = repelem([Controller.controller.clone()],Robot.number);
...
[pos,vel] = simulateKinematics(Robot,Controller,Map)
